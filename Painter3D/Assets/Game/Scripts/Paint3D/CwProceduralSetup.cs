...
using UnityEditor;
using UnityEngine;
using CwPaintableMesh = Game.Paint3D.Painting.Required.CwPaintableMesh;
using CwPaintableMeshTexture = Game.Paint3D.Painting.Required.CwPaintableMeshTexture;
...
namespace Game.Paint3D
{
	...
	[HelpURL(Game.Paint3D.Core.CwCommon.HelpUrlPrefix + "CwProceduralSetup")]
	[AddComponentMenu(Game.Paint3D.Core.CwCommon.ComponentMenuPrefix + "Procedural Setup")]
	...
	[CustomEditor(typeof(CwProceduralSetup))]
	public class CwProceduralSetup_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwProceduralSetup tgt; CwProceduralSetup[] tgts; GetTargets(out tgt, out tgts);
