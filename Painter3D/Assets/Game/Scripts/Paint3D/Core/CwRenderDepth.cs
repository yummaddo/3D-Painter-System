...
namespace Game.Paint3D.Core
{
	...
	public class CwRenderDepth : MonoBehaviour
	{
		...
		public void ReadNow()
		{
			...
			{
				cachedShader = Shader.Find("Hidden/Paint Core/CwRenderDepth");
			}
	...
	[CustomEditor(typeof(CwRenderDepth))]
	public class CwRenderDepth_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwRenderDepth tgt; CwRenderDepth[] tgts; GetTargets(out tgt, out tgts);
