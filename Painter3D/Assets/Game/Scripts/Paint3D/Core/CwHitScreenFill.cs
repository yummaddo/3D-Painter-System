...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Screen Fill")]
	...
	[CustomEditor(typeof(CwHitScreenFill))]
	public class CwHitScreenFill_Editor : CwHitScreen_Editor
	{
		protected override void DrawBasic()
		{
			CwHitScreenFill tgt; CwHitScreenFill[] tgts; GetTargets(out tgt, out tgts);
