...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Screen Line")]
	...
	[CustomEditor(typeof(CwHitScreenLine))]
	public class CwHitScreenLine_Editor : CwHitScreenBase_Editor
	{
		protected override void OnInspector()
		{
			CwHitScreenLine tgt; CwHitScreenLine[] tgts; GetTargets(out tgt, out tgts);
