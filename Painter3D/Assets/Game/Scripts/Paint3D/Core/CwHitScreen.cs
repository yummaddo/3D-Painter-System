...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Screen")]
	...
	[CustomEditor(typeof(CwHitScreen))]
	public class CwHitScreen_Editor : CwHitScreenBase_Editor
	{
		protected override void OnInspector()
		{
			CwHitScreen tgt; CwHitScreen[] tgts; GetTargets(out tgt, out tgts);
