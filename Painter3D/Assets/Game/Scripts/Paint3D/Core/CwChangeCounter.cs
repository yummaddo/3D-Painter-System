...
#if UNITY_EDITOR
	[CustomEditor(typeof(CwChangeCounter))]
	public class CwChangeCounter_Editor : CwPaintableTextureMonitorMask_Editor
	{
		protected override void OnInspector()
		{
			CwChangeCounter tgt; CwChangeCounter[] tgts; GetTargets(out tgt, out tgts);
		...
		private void DrawTexture(CwChangeCounter[] tgts, bool dirtyChange)
		{
		...
		private void DrawColor(CwChangeCounter[] tgts, bool dirtyChange)
		{
			EditorGUILayout.BeginHorizontal();
