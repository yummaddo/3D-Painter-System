...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Particles")]
...
#if UNITY_EDITOR
	[CustomEditor(typeof(CwHitParticles))]
	public class CwHitParticles_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwHitParticles tgt; CwHitParticles[] tgts; GetTargets(out tgt, out tgts);
