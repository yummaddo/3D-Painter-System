...
namespace Game.Paint3D.Core
{
	...
	[CustomEditor(typeof(CwPaintableTexture))]
	public class CwPaintableTexture_Editor : CwEditor
	{
		...
		{
			CwPaintableTexture tgt; CwPaintableTexture[] tgts; GetTargets(out tgt, out tgts);
		...
		private void DrawSaveName(CwPaintableTexture[] tgts)
		{
			/*
			var rect  = Reserve();
		...
		private void DrawSize(CwPaintableTexture[] tgts)
		{
			var rect  = Reserve();
		...
		private void DrawTexture(CwPaintableTexture[] tgts)
		{
			var rect  = Reserve();
			var rectL = rect; rectL.xMax -= 50;
			var rectR = rect; rectR.xMin = rectR.xMax - 48;
