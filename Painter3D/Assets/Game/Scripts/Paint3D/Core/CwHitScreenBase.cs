...
namespace Game.Paint3D.Core
{
	...
	public abstract class CwHitScreenBase : MonoBehaviour
	{
	...
	[CustomEditor(typeof(CwHitScreenBase))]
	public class CwHitScreenBase_Editor : CwEditor
	{
		protected virtual void DrawBasic()
		{
			CwHitScreenBase tgt; CwHitScreenBase[] tgts; GetTargets(out tgt, out tgts);
