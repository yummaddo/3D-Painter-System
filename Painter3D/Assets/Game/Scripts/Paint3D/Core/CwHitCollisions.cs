...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Collisions")]
	public class CwHitCollisions : MonoBehaviour
	{
		...
		private void CheckCollision(Collision collision)
		{
			...
			if (impulse >= pressureMin)
			{
				...
				var finalUp       = orientation == OrientationType.CameraUp ? CwCommon.GetCameraUp(_camera) : Vector3.up;
	...
	[CustomEditor(typeof(CwHitCollisions))]
	public class CwHitCollisions_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwHitCollisions tgt; CwHitCollisions[] tgts; GetTargets(out tgt, out tgts);
