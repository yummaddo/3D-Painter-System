...
namespace Game.Paint3D.Core
{
	...
	[CustomEditor(typeof(CwHitNearby))]
	public class CwHitNearby_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwHitNearby tgt; CwHitNearby[] tgts; GetTargets(out tgt, out tgts);
			...
			if (Any(tgts, t => t.PaintIn == CwHitNearby.PhaseType.Update || t.PaintIn == CwHitNearby.PhaseType.FixedUpdate))
			{
