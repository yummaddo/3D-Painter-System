...
namespace Game.Paint3D.Core
{
	...
	[AddComponentMenu(CwCommon.ComponentHitMenuPrefix + "Hit Through")]
	...
	[CustomEditor(typeof(CwHitThrough))]
	public class CwHitThrough_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwHitThrough tgt; CwHitThrough[] tgts; GetTargets(out tgt, out tgts);
