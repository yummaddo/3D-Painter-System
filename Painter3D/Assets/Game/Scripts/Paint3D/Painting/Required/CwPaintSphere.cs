...
namespace Game.Paint3D.Painting.Required
{
	...
	[AddComponentMenu(Game.Paint3D.Core.CwCommon.ComponentHitMenuPrefix + "Paint Sphere")]
	public class CwPaintSphere : MonoBehaviour, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		private void HandleMaskCommon(Vector3 worldPosition)
		{
			...
			CwCommandSphere.Instance.DepthMask = depthMask;
		}
	...
	[CustomEditor(typeof(CwPaintSphere))]
	public class CwClickToPaintSphere_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwPaintSphere tgt; CwPaintSphere[] tgts; GetTargets(out tgt, out tgts);
