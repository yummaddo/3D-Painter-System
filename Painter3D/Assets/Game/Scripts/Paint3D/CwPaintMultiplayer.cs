...
namespace Game.Paint3D
{
	...
	[ExecuteInEditMode]
	[HelpURL(Game.Paint3D.Core.CwCommon.HelpUrlPrefix + "CwPaintMultiplayer")]
	[AddComponentMenu(Game.Paint3D.Core.CwCommon.ComponentHitMenuPrefix + "Paint Multiplayer")]
	...
	[CustomEditor(typeof(CwPaintMultiplayer))]
	public class CwPaintMultiplayer_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			CwPaintMultiplayer tgt; CwPaintMultiplayer[] tgts; GetTargets(out tgt, out tgts);
